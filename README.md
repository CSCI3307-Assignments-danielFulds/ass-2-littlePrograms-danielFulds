...
RQ2.1 7.	Write a program  (call it Program_RQ_2_1), that displays the result of
5.5	x 2.5 – 1.3 x 3
-----------------------
31.5 – 1.5
...
Fig. 4.4 | Student class that stores a student name and average
...
Fig. 4.15 | Prefix increment and postfix increment operators
...
of pennies. Then break the result into its dollars and cents portions by using the division and remainder operations, respectively. Insert a period between the dollars and the cents portions.]
